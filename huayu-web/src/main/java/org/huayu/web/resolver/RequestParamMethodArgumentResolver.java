...
import org.huayu.web.annotation.RequestParam;
import org.huayu.web.convert.ConvertComposite;
import org.huayu.web.handler.HandlerMethod;
import org.huayu.web.multipartFile.MultipartFile;
        ...
        for (Field field : fields) {
            ...
            if (BeanUtils.isSimpleProperty(type)){
                if (parameterMap.containsKey(field.getName())){
                    ...
                    field.set(o,convertComposite.convert(handlerMethod,field.getType(),parameterMap.get(field.getName())[0]));
